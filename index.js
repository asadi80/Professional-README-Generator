...
const creatIndex = require('./src/creatIndex.js')
...
function writeToFileIndex(fileName, data) {
    fs.writeFile(fileName, data, (err) => {
        if (err)
            throw err;
        console.log('Success! Information transferred to the index.html!')
    });
};
...
function init() {
    ...
    .then(function (userInput) {
        ...
        writeToFileIndex('./dist/index.html', creatIndex(userInput));
    });
};
